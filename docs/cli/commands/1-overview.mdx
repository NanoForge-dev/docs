...
<CardGroup cols={2}>
  ...
  <Card title="create" href="./2-commands/5-create">
    Create a single component or system.
  </Card>
  <Card title="install / add" href="./2-commands/6-install">
    Add components, systems, or libraries from the registry.
  </Card>
  <Card title="editor" href="./2-commands/7-editor">
    Launch the NanoForge visual editor.
  </Card>
  <Card title="registry" href="./2-commands/8-registry">
